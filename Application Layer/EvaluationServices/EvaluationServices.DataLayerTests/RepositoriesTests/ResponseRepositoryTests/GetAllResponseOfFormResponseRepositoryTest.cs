...
namespace EvaluationServices.DataLayerTests.RepositoriesTests.ResponseRepositoryTests
{
    [TestClass]
    public class GetAllResponseOfFormResponseRepositoryTest
    {
        ...
        public void GetAllResponseOfFormWithAttendeeIdAndSessionId()
        {
            ...
            using (var memoryContext = new EvaluationContext(options))
            {
                ...
                // Act
                var result = responseRepository.GetAllOfForm(responseAdded1.Question.Form.Id);
